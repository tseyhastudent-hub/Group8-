...
<script src="UI.js?1759389173461"></script>
<script>
...
function init() {
	...
	var comp=AdobeAn.getComposition("FA56DE08ED8E3640BCDD53EA5B715ED8");
...
function handleComplete(evt,comp) {
	...
	// --- START of new code ---
	// IMPORTANT: Replace 'learn_btn' with your button's actual instance name from Adobe Animate.
	exportRoot.learn_btn.addEventListener("click", function() {
