...
lib.ssMetadata = [
		{name:"Learn_atlas_1", frames: [[1351,1006,615,587],[0,0,987,881],[0,1280,682,596],[0,883,1099,395],[1351,397,606,607],[989,0,1002,395],[684,1280,665,583]]},
		{name:"Learn_atlas_2", frames: [[0,396,821,395],[823,396,547,548],[0,793,821,395],[0,0,864,394],[823,946,522,531],[0,1190,821,395]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(580.4,264,1,1,0,0,0,596.4,258);

	this.instance_1 = new lib.Starletter();
	this.instance_1.setTransform(883,567,0.2838,0.281);

	this.instance_2 = new lib.heartletter();
	this.instance_2.setTransform(235,576,0.2838,0.281);

	this.instance_3 = new lib.Pentagonletter();
	this.instance_3.setTransform(569,577,0.212,0.281);

	this.instance_4 = new lib.circleletter();
	this.instance_4.setTransform(556,313,0.2838,0.281);

	this.instance_5 = new lib.Squareletter();
	this.instance_5.setTransform(230,313,0.2697,0.2817);

	this.instance_6 = new lib.triangleletter();
	this.instance_6.setTransform(882,313,0.2334,0.281);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},19).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).wait(20));
	...
	this.instance_7.setTransform(1000.45,504.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_7, 0, 1, 2, false, new lib.Symbol8(), 3);

	this.instance_8 = new lib.Symbol7();
	this.instance_8.setTransform(681.45,504.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_8, 0, 1, 2, false, new lib.Symbol7(), 3);

	this.instance_9 = new lib.Symbol6();
	this.instance_9.setTransform(347.45,504.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_9, 0, 1, 2, false, new lib.Symbol6(), 3);

	this.instance_10 = new lib.Symbol5();
	this.instance_10.setTransform(1000.45,233.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_10, 0, 1, 2, false, new lib.Symbol5(), 3);

	this.instance_11 = new lib.Symbol4();
	this.instance_11.setTransform(675.45,233.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_11, 0, 1, 2, false, new lib.Symbol4(), 3);

	this.instance_12 = new lib.Symbol3();
	this.instance_12.setTransform(347.45,233.15,1,1,0,0,0,81.4,78.9);
	new cjs.ButtonHelper(this.instance_12, 0, 1, 2, false, new lib.Symbol3(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.readbtn}]}).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]},19).wait(21));

	// background
	this.instance_13 = new lib.Symbol2("synched",0);
	this.instance_13.setTransform(806.5,453.4,1,1,0,0,0,420.5,216.4);

	this.instance_14 = new lib.background();
	this.instance_14.setTransform(-16,-11,0.1612,0.0933);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_14},{t:this.instance_13}]}).to({state:[{t:this.instance_14}]},19).wait(21));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/background.png?1759653311638", id:"background"},
		{src:"images/Buttonread.png?1759653311638", id:"Buttonread"},
		{src:"images/Learn_1.png?1759653311638", id:"Learn_1"},
		{src:"images/note.png?1759653311638", id:"note"},
		{src:"images/showshape.png?1759653311638", id:"showshape"},
		{src:"images/Learn_atlas_1.png?1759653311578", id:"Learn_atlas_1"},
		{src:"images/Learn_atlas_2.png?1759653311579", id:"Learn_atlas_2"},
		{src:"sounds/circlesoundwav.mp3?1759653311638", id:"circlesoundwav"},
		{src:"sounds/heartsoundwav.mp3?1759653311638", id:"heartsoundwav"},
		{src:"sounds/pentagonsoundwav.mp3?1759653311638", id:"pentagonsoundwav"},
		{src:"sounds/squaresoundwav.mp3?1759653311638", id:"squaresoundwav"},
		{src:"sounds/startsoundwav.mp3?1759653311638", id:"startsoundwav"},
		{src:"sounds/trianglesoundwav.mp3?1759653311638", id:"trianglesoundwav"}
	],
	preloads: []
};
